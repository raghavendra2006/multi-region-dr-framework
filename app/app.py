...
def read_data():
    ...
    try:
        ...
        return jsonify([{'value': row['value'], 'created_at': row['created_at']} for row in rows])
    except Exception as e:
...
if __name__=="__main__":
    logger.warning("Running the built-in Flask development server is not recommended for production.")
